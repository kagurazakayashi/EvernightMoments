...
COPY readme\*.html bin\%PNAME%_macos-x64\
...
COPY readme\*.html bin\%PNAME%_macos-arm64\
...
COPY readme\*.html bin\%PNAME%_linux-x86\
...
COPY readme\*.html bin\%PNAME%_linux-x64\
...
COPY readme\*.html bin\%PNAME%_linux-arm32\
...
COPY readme\*.html bin\%PNAME%_linux-arm64\
